 ...
 * ===================================================
 * Trabalho 2 – base compartilhada (DC/UFSCar)
 *
 * Esta gramática é usada pelo ANTLR4 para gerar LALexer, LAParser,
 * LABaseVisitor, etc. (T3: analisador semântico via Visitor).
 */
grammar LA;
